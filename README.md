...
|---|---|
| [System overview](docs/diagrams/system-overview.html) | One source, two serve paths: CSV seed → PostgreSQL serves the app live; PostgreSQL snapshots → Databricks medallion → Gold serves BI |
